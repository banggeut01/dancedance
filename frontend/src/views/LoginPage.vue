<template>
  <div>
    ...
    <div v-if="!islogin" class="logo-div">
      <v-btn depressed style="background-color: rgba(0,0,0,0);" to="/"><p class="neon">DANCE_DANCE</p></v-btn>
    </div>
    <!-- background img -->
...
<script>
  ...
  export default {
    ...
    data: () => ({
      length: 2,
      window: 0,
      componentTags: ['', '<LoginForm></LoginForm>', '<SignUpForm></SignUpForm>']
    }),
    components: {
      LoginForm,
      SignUpForm
