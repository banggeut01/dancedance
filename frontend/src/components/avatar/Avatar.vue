...
<style>
    ...
    .selectedGlow {
        color: #fff;
        box-shadow: 0 0 100px #fff, 0 0 100px #fff, 0 0 100px gold, 0 0 100px gold,
            0 0 100px gold, 0 0 100px gold;
    ...
    .unselectedGlow {
        color: #fff;
        box-shadow: 0 0 1px #fff, 0 0 10px #fff, 0 0 10px #9F00C5, 0 0 10px #9F00C5,
            0 0 10px #9F00C5, 0 0 10px #9F00C5;
